...
np.save('player5000.npy', Q_table)
np.save('imposter5000.npy', Q_table_imp)
...
# Show the plot
plt.savefig(f"{presworkdir}/figures5000/player.png")
plt.show()
...
# Show the plot
plt.savefig(f"{presworkdir}/figures5000/Imposter.png")
plt.show()
...
# Show the plot
plt.savefig(f"{presworkdir}/figures5000/time-taken.png")
plt.show()
...
# Show the plot
plt.savefig(f"{presworkdir}/figures5000/player-reward.png")
plt.show()
...
# Show the plot
plt.savefig(f"{presworkdir}/figures5000/imposter_reward.png")
plt.show()
